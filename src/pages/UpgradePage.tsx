...
const PLANS = [
  {
    ...
    price: 79000,
    period: '/bulan',
    desc: 'Untuk usaha rumahan & toko kecil yang baru mulai',
    ...
    features: [
      ...
      'Pre-order manual (maks 20/bulan)',
      'Voucher diskon',
    ],
  },
  {
    ...
    features: [
      ...
      'Inventori & Resep + Food Cost',
      'Produksi + Forecast',
      'Pre-order unlimited + Link Publik',
      'Manajemen Pelanggan + Loyalitas',
      'WA Broadcast & Notifikasi',
      'Purchase Order',
  ...
  },
  {
    ...
    features: [
      'Outlet & staff tidak terbatas',
      'Semua fitur Pro',
      'Manajemen Reseller & Agen',
      'API Access',
      'White Label & Custom Branding',
      'Priority Support (WA langsung)',
    ],
  },
]
